...
namespace DoonaLegend
{
    ...
    public class SectionContent
    {
        ...
        public int[,] terrains;
        public Dictionary<int, Dictionary<int, int>> objects;

        public SectionContent(int unitLength, string fileName, int[,] terrains, Dictionary<int, Dictionary<int, int>> objects)
        {
